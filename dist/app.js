...
exports.mixin = mixin;
},{"vue":"../node_modules/vue/dist/vue.common.js"}],"../node_modules/vue-smooth-reflow/dist/vue-smooth-reflow.min.js":[function(require,module,exports) {
var define;
...
},{"process":"../../../../../usr/local/lib/node_modules/parcel/node_modules/process/browser.js"}],"../node_modules/vue-slick/dist/slickCarousel.esm.js":[function(require,module,exports) {
"use strict";
...
var script = {
  ...
  destroyed: function () {
    (0, _jquery.default)(this.$el).slick('unslick');
  },
  methods: {
    create: function () {
      var $slick = (0, _jquery.default)(this.$el);
    ...
    next: function () {
      (0, _jquery.default)(this.$el).slick('slickNext');
    },
    prev: function () {
      (0, _jquery.default)(this.$el).slick('slickPrev');
    },
    pause: function () {
      (0, _jquery.default)(this.$el).slick('slickPause');
    },
    play: function () {
      (0, _jquery.default)(this.$el).slick('slickPlay');
    },
    goTo: function (index, dontAnimate) {
      (0, _jquery.default)(this.$el).slick('slickGoTo', index, dontAnimate);
    },
    currentSlide: function () {
      return (0, _jquery.default)(this.$el).slick('slickCurrentSlide');
    },
    add: function (element, index, addBefore) {
      (0, _jquery.default)(this.$el).slick('slickAdd', element, index, addBefore);
    },
    remove: function (index, removeBefore) {
      (0, _jquery.default)(this.$el).slick('slickRemove', index, removeBefore);
    },
    filter: function (filterData) {
      (0, _jquery.default)(this.$el).slick('slickFilter', filterData);
    },
    unfilter: function () {
      (0, _jquery.default)(this.$el).slick('slickUnfilter');
    },
    getOption: function (option) {
      (0, _jquery.default)(this.$el).slick('slickGetOption', option);
    },
    setOption: function (option, value, refresh) {
      (0, _jquery.default)(this.$el).slick('slickSetOption', option, value, refresh);
    },
    setPosition: function () {
      (0, _jquery.default)(this.$el).slick('setPosition');
    },
    // Events
...
var slick = createCommonjsModule(function (module, exports) {
  (function (factory) {
    {
      module.exports = factory(_jquery.default);
    }
  })(function ($$$1) {
...
var _default = slickCarousel;
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
if (typeof window !== 'undefined') {
...
},{}],"components/Slick.vue":[function(require,module,exports) {
"use strict";
...
var _vueSlick = _interopRequireDefault(require("vue-slick"));
...
exports.default = _default;
        var $b66f1f = exports.default || module.exports;
      
      if (typeof $b66f1f === 'function') {
        $b66f1f = $b66f1f.options;
      }
    
        /* template */
        Object.assign($b66f1f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c(
        ...
        _vm._l(_vm.bannerQty, function(link, index) {
          return _c("a", { attrs: { href: link } }, [
            _c("img", {
              attrs: {
                src: "/img/banner/banner_" + (index + 1) + ".jpg",
                alt: ""
              }
            })
          ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b66f1f', $b66f1f);
          } else {
            api.reload('$b66f1f', $b66f1f);
          }
        }
...
},{"vue-slick":"../node_modules/vue-slick/dist/slickCarousel.esm.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var _vueSmoothReflow = _interopRequireDefault(require("vue-smooth-reflow"));
...
window.document.addEventListener("DOMContentLoaded", function () {
  var app = new _vue.default({
    el: '#app',
    mixins: [_vueClickaway.mixin, _vueSmoothReflow.default],
    data: function data() {
      return {
        dropdown: false,
...
},{"vue":"../node_modules/vue/dist/vue.common.js","vue-clickaway":"../node_modules/vue-clickaway/dist/vue-clickaway.common.js","vue-smooth-reflow":"../node_modules/vue-smooth-reflow/dist/vue-smooth-reflow.min.js","aos":"../node_modules/aos/dist/aos.js","./components/Slick.vue":"components/Slick.vue"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
